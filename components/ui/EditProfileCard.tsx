...
export default function EditProfileCard() {
  ...
  return (
    <div
      className={
        "h-screen w-screen backdrop-blur-md bg-black/50 absolute top-0 left-0 flex items-center justify-center"
      }
    >
      <Card
        className={
          "w-100 h-auto px-7 py-10 bg-white z-51 flex flex-col items-center rounded-xl gap-4 "
        }
      >
        ...
        <div
          onClick={selectImage}
          className={
            "h-25 w-25 border rounded-full flex items-center justify-center  border-gray-200"
          }
        >
          {avatarPreview ? (
            <Image
        ...
        <textarea
          ...
          className={
            "w-full border border-gray-200 h-25 rounded-xl p-4 resize-none px-5"
          }
          placeholder={"Bio"}
        />
        <Button
